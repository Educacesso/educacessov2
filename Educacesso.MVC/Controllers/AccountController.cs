...
using Educacesso.Infra.Repositories.Contexto;
...
namespace Educacesso.MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<UserIdentity>(new UserStore<UserIdentity>(new EducacessoContexto())))
        {
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Usuario ou senha errado.");
                }
            }
